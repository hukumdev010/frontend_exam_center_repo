    ...
    return (
        <div
            className="group bg-gradient-to-br from-white to-blue-50/30 rounded-2xl border border-blue-100/50 p-6 
                     ...
                     hover:scale-105 transform hover:border-blue-200 min-h-[320px] flex flex-col"
        ...
        >
            <div className="flex items-start justify-between mb-4">
                ...
                <span className={`text-xs px-3 py-1.5 rounded-full font-medium shrink-0 ${teacher.is_available
