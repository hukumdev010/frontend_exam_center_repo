...
// FilterProvider and useFilters removed
...
// Define DashboardHeader component outside to avoid recreation during render
...
function DashboardLayoutInner({
    ...
    const learningItems: SidebarItem[] = [
        { title: "My Progress", href: "/dashboard/learning", icon: Target },
    ...
    // Calculate layout margins based on sidebars
    const getMainContentClass = () => {
        const marginLeft = collapsed ? "lg:ml-16" : "lg:ml-64"; // Navigation sidebar margin only
